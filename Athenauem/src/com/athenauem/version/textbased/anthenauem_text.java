 ...
 *  
 *  	-class Values was created to be able to hold two Strings to be placed in a hashmaps value position.
 *  	-the key is a string, defined as the username, and the Value class holds the password and origin of use.
 *  
...
public class anthenauem_text extends password_controller_txt {
